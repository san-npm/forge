 ...
 * three items are owner-confirmable, with NO fabricated precise figures:
 *  - `years`: 10+ years covers BOTH building products and marketing work, hence
 ...
 *  - `europe`: a qualitative credential rendered as Anton text (not a number):
 *    the studio builds and hosts in Europe, matching the "European by default"
 *    positioning in the trust section.
...
const PROOF_METRICS_I18N: Record<Locale, ProofMetric[]> = {
  ...
  fr: [
    { id: 'years', label: 'Ans à construire et à marketer', value: 10, suffix: '+' },
    { id: 'disciplines', label: 'Disciplines livrées : IA, web et on-chain', value: 3, suffix: '' },
    { id: 'europe', label: 'Conçu et hébergé en Europe', value: null, text: 'Europe' },
  ],
  de: [
    { id: 'years', label: 'Jahre Aufbau und Marketing', value: 10, suffix: '+' },
    { id: 'disciplines', label: 'Gelieferte Disziplinen: KI, Web und On-Chain', value: 3, suffix: '' },
    { id: 'europe', label: 'In Europa gebaut und gehostet', value: null, text: 'Europa' },
  ],
};
