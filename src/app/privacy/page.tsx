...
const sections: { title: Record<string, string>; content: Record<string, string> }[] = [
  ...
  },
  {
    ...
    content: {
      fr: 'Forge n\u2019utilise aucun cookie, aucun traceur et aucune technologie de suivi. Votre choix de langue est conserv\u00e9 uniquement dans l\u2019\u00e9tat de l\u2019application (m\u00e9moire du navigateur) et n\u2019est pas persist\u00e9 entre les sessions.',
      en: 'Forge does not use any cookies, trackers, or tracking technologies. Your language preference is kept only in the application state (browser memory) and is not persisted between sessions.',
      lb: 'Forge does not use any cookies, trackers, or tracking technologies. Your language preference is kept only in the application state (browser memory) and is not persisted between sessions.',
      de: 'Forge does not use any cookies, trackers, or tracking technologies. Your language preference is kept only in the application state (browser memory) and is not persisted between sessions.',
      it: 'Forge does not use any cookies, trackers, or tracking technologies. Your language preference is kept only in the application state (browser memory) and is not persisted between sessions.',
      pt: 'Forge does not use any cookies, trackers, or tracking technologies. Your language preference is kept only in the application state (browser memory) and is not persisted between sessions.',
    },
  },
  {
    title: {
  ...
  },
  {
    ...
    content: {
      fr: 'Le responsable du traitement des donn\u00e9es est Forge, bas\u00e9 au Luxembourg. Pour toute question relative \u00e0 la protection de vos donn\u00e9es personnelles, vous pouvez nous contacter \u00e0 l\u2019adresse : privacy@forge-simulator.lu',
      en: 'The data controller is Forge, based in Luxembourg. For any questions regarding the protection of your personal data, you may contact us at: privacy@forge-simulator.lu',
      lb: 'The data controller is Forge, based in Luxembourg. For any questions regarding the protection of your personal data, you may contact us at: privacy@forge-simulator.lu',
      de: 'The data controller is Forge, based in Luxembourg. For any questions regarding the protection of your personal data, you may contact us at: privacy@forge-simulator.lu',
      it: 'The data controller is Forge, based in Luxembourg. For any questions regarding the protection of your personal data, you may contact us at: privacy@forge-simulator.lu',
      pt: 'The data controller is Forge, based in Luxembourg. For any questions regarding the protection of your personal data, you may contact us at: privacy@forge-simulator.lu',
    },
  },
  {
    title: {
