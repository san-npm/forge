...
const sections: { title: Record<string, string>; content: Record<string, string> }[] = [
  ...
  },
  {
    ...
    content: {
      fr: 'Le responsable du traitement des donn\u00e9es est COMMIT MEDIA SARL (RCS B276192), bas\u00e9e au Luxembourg, \u00e9ditrice du service OpenLetz (openletz.ai). Pour toute question relative \u00e0 la protection de vos donn\u00e9es personnelles, vous pouvez nous contacter \u00e0 l\u2019adresse : privacy@openletz.ai',
      en: 'The data controller is COMMIT MEDIA SARL (RCS B276192), based in Luxembourg, publisher of the OpenLetz service (openletz.ai). For any questions regarding the protection of your personal data, you may contact us at: privacy@openletz.ai',
      lb: 'The data controller is COMMIT MEDIA SARL (RCS B276192), based in Luxembourg, publisher of the OpenLetz service (openletz.ai). For any questions regarding the protection of your personal data, you may contact us at: privacy@openletz.ai',
      de: 'The data controller is COMMIT MEDIA SARL (RCS B276192), based in Luxembourg, publisher of the OpenLetz service (openletz.ai). For any questions regarding the protection of your personal data, you may contact us at: privacy@openletz.ai',
      it: 'The data controller is COMMIT MEDIA SARL (RCS B276192), based in Luxembourg, publisher of the OpenLetz service (openletz.ai). For any questions regarding the protection of your personal data, you may contact us at: privacy@openletz.ai',
      pt: 'The data controller is COMMIT MEDIA SARL (RCS B276192), based in Luxembourg, publisher of the OpenLetz service (openletz.ai). For any questions regarding the protection of your personal data, you may contact us at: privacy@openletz.ai',
    },
  },
  {
    title: {
