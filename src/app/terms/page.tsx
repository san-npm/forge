...
const sections: { title: Record<string, string>; content: Record<string, string> }[] = [
  {
    ...
    content: {
      fr: 'OpenLetz (openletz.com) est un service \u00e9dit\u00e9 par COMMIT MEDIA SARL (RCS B276192), soci\u00e9t\u00e9 de droit luxembourgeois. Il s\u2019agit d\u2019une plateforme en ligne gratuite qui propose :\n\n\u2022 Un simulateur d\u2019\u00e9ligibilit\u00e9 aux subventions : identifiez en quelques secondes les programmes de financement luxembourgeois pour la transformation digitale et l\u2019innovation IA auxquels votre PME pourrait \u00eatre \u00e9ligible.\n\u2022 Un annuaire d\u2019agents IA : d\u00e9couvrez les meilleurs outils d\u2019intelligence artificielle pour votre entreprise, avec des informations sur la conformit\u00e9 RGPD et les tarifs.\n\u2022 Un blog : actualit\u00e9s, guides et conseils sur les aides luxembourgeoises et l\u2019innovation digitale.',
      en: 'OpenLetz (openletz.com) is a service published by COMMIT MEDIA SARL (RCS B276192), a company incorporated under Luxembourg law. It is a free online platform that offers:\n\n\u2022 A grant eligibility simulator: identify in seconds which Luxembourg funding programs for digital transformation and AI innovation your SME may be eligible for.\n\u2022 An AI agents directory: discover the best artificial intelligence tools for your business, with information on GDPR compliance and pricing.\n\u2022 A blog: news, guides, and tips about Luxembourg grants and digital innovation.',
      lb: 'OpenLetz (openletz.com) is a service published by COMMIT MEDIA SARL (RCS B276192), a company incorporated under Luxembourg law. It is a free online platform that offers:\n\n\u2022 A grant eligibility simulator: identify in seconds which Luxembourg funding programs for digital transformation and AI innovation your SME may be eligible for.\n\u2022 An AI agents directory: discover the best artificial intelligence tools for your business, with information on GDPR compliance and pricing.\n\u2022 A blog: news, guides, and tips about Luxembourg grants and digital innovation.',
      de: 'OpenLetz (openletz.com) is a service published by COMMIT MEDIA SARL (RCS B276192), a company incorporated under Luxembourg law. It is a free online platform that offers:\n\n\u2022 A grant eligibility simulator: identify in seconds which Luxembourg funding programs for digital transformation and AI innovation your SME may be eligible for.\n\u2022 An AI agents directory: discover the best artificial intelligence tools for your business, with information on GDPR compliance and pricing.\n\u2022 A blog: news, guides, and tips about Luxembourg grants and digital innovation.',
      it: 'OpenLetz (openletz.com) is a service published by COMMIT MEDIA SARL (RCS B276192), a company incorporated under Luxembourg law. It is a free online platform that offers:\n\n\u2022 A grant eligibility simulator: identify in seconds which Luxembourg funding programs for digital transformation and AI innovation your SME may be eligible for.\n\u2022 An AI agents directory: discover the best artificial intelligence tools for your business, with information on GDPR compliance and pricing.\n\u2022 A blog: news, guides, and tips about Luxembourg grants and digital innovation.',
      pt: 'OpenLetz (openletz.com) is a service published by COMMIT MEDIA SARL (RCS B276192), a company incorporated under Luxembourg law. It is a free online platform that offers:\n\n\u2022 A grant eligibility simulator: identify in seconds which Luxembourg funding programs for digital transformation and AI innovation your SME may be eligible for.\n\u2022 An AI agents directory: discover the best artificial intelligence tools for your business, with information on GDPR compliance and pricing.\n\u2022 A blog: news, guides, and tips about Luxembourg grants and digital innovation.',
    },
  },
  {
    title: {
  ...
  },
  {
    ...
    content: {
      fr: 'OpenLetz ne saurait \u00eatre tenu responsable des d\u00e9cisions prises sur la base des r\u00e9sultats de la simulation. Le service est fourni \u00ab tel quel \u00bb, sans garantie d\u2019aucune sorte, expresse ou implicite. OpenLetz d\u00e9cline toute responsabilit\u00e9 en cas de perte financi\u00e8re, de manque \u00e0 gagner ou de tout autre dommage r\u00e9sultant de l\u2019utilisation ou de l\u2019impossibilit\u00e9 d\u2019utiliser le service.',
      en: 'OpenLetz shall not be held liable for any decisions made based on the simulation results. The service is provided "as is", without warranty of any kind, express or implied. OpenLetz disclaims all liability for financial loss, lost profits, or any other damages resulting from the use or inability to use the service.',
      lb: 'OpenLetz shall not be held liable for any decisions made based on the simulation results. The service is provided "as is", without warranty of any kind, express or implied. OpenLetz disclaims all liability for financial loss, lost profits, or any other damages resulting from the use or inability to use the service.',
      de: 'OpenLetz shall not be held liable for any decisions made based on the simulation results. The service is provided "as is", without warranty of any kind, express or implied. OpenLetz disclaims all liability for financial loss, lost profits, or any other damages resulting from the use or inability to use the service.',
      it: 'OpenLetz shall not be held liable for any decisions made based on the simulation results. The service is provided "as is", without warranty of any kind, express or implied. OpenLetz disclaims all liability for financial loss, lost profits, or any other damages resulting from the use or inability to use the service.',
      pt: 'OpenLetz shall not be held liable for any decisions made based on the simulation results. The service is provided "as is", without warranty of any kind, express or implied. OpenLetz disclaims all liability for financial loss, lost profits, or any other damages resulting from the use or inability to use the service.',
    },
  },
  {
    title: {
  ...
  },
  {
    ...
    content: {
      fr: 'Pour toute question relative aux pr\u00e9sentes conditions d\u2019utilisation, vous pouvez nous contacter \u00e0 l\u2019adresse : bob@openletz.com',
      en: 'For any questions regarding these terms of service, you may contact us at: bob@openletz.com',
      lb: 'For any questions regarding these terms of service, you may contact us at: bob@openletz.com',
      de: 'For any questions regarding these terms of service, you may contact us at: bob@openletz.com',
      it: 'For any questions regarding these terms of service, you may contact us at: bob@openletz.com',
      pt: 'For any questions regarding these terms of service, you may contact us at: bob@openletz.com',
    },
  },
]
