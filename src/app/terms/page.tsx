...
const sections: { title: Record<string, string>; content: Record<string, string> }[] = [
  ...
  },
  {
    ...
    content: {
      fr: 'Pour toute question relative aux pr\u00e9sentes conditions d\u2019utilisation, vous pouvez nous contacter \u00e0 l\u2019adresse : contact@forge-simulator.lu',
      en: 'For any questions regarding these terms of service, you may contact us at: contact@forge-simulator.lu',
      lb: 'For any questions regarding these terms of service, you may contact us at: contact@forge-simulator.lu',
      de: 'For any questions regarding these terms of service, you may contact us at: contact@forge-simulator.lu',
      it: 'For any questions regarding these terms of service, you may contact us at: contact@forge-simulator.lu',
      pt: 'For any questions regarding these terms of service, you may contact us at: contact@forge-simulator.lu',
    },
  },
]
