...
function GdprBadge({ status }: { status: boolean | 'partial' }) {
  if (status === true) {
    return (
      <span title="GDPR Compliant" className="inline-flex items-center gap-1 px-2 py-0.5 text-xs font-medium bg-green-50 text-green-700 rounded-full border border-green-200">
  ...
  if (status === 'partial') {
    return (
      <span title="Partial GDPR" className="inline-flex items-center gap-1 px-2 py-0.5 text-xs font-medium bg-amber-50 text-amber-700 rounded-full border border-amber-200">
        <svg className="w-3 h-3" fill="currentColor" viewBox="0 0 20 20">
...
export default function AgentsPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      {/* Main content */}
      <div className="flex-1 max-w-6xl mx-auto px-4 w-full -mt-4 pb-16">
        {/* Category filter */}
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex flex-wrap items-center gap-1.5 mb-3">
                      ...
                      <GdprBadge status={agent.euCompliance.gdprCompliant} />
                      {cat && (
