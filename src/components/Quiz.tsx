...
const questions: Question[] = [
  ...
  {
    titleKey: 'q3.title',
    answerKey: 'hqLuxembourg',
    options: [
      { labelKey: 'q3.o1', value: 'yes' },
      { labelKey: 'q3.o2', value: 'no' },
    ],
  },
  {
    titleKey: 'q4.title',
    answerKey: 'businessPermit',
    options: [
      { labelKey: 'q4.o1', value: 'yes' },
      { labelKey: 'q4.o2', value: 'no' },
      { labelKey: 'q4.o3', value: 'unknown' },
    ],
  },
  {
    titleKey: 'q5.title',
    ...
    options: [
      { labelKey: 'q5.o1', value: 'nothing' },
      { labelKey: 'q5.o2', value: 'basic-site' },
      { labelKey: 'q5.o3', value: 'site-social' },
      { labelKey: 'q5.o4', value: 'management-tools' },
    ],
  },
  {
    titleKey: 'q6.title',
    ...
    options: [
      { labelKey: 'q6.o1', value: 'find-clients' },
      { labelKey: 'q6.o2', value: 'manage-admin' },
      { labelKey: 'q6.o3', value: 'communicate' },
      { labelKey: 'q6.o4', value: 'save-time' },
      { labelKey: 'q6.o5', value: 'other' },
    ],
  },
  {
    titleKey: 'q7.title',
    answerKey: 'aiUsage',
    options: [
      { labelKey: 'q7.o1', value: 'never' },
      { labelKey: 'q7.o2', value: 'a-little' },
      { labelKey: 'q7.o3', value: 'regularly' },
    ],
  },
  {
    titleKey: 'q8.title',
    answerKey: 'budget',
    options: [
      { labelKey: 'q8.o1', value: '<3k' },
      { labelKey: 'q8.o2', value: '3-10k' },
      { labelKey: 'q8.o3', value: '10-25k' },
      { labelKey: 'q8.o4', value: '>25k' },
      { labelKey: 'q8.o5', value: 'no-idea' },
    ],
  },
]
